...
function Workflow() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden text-center bg-orange-100 text-black">
      <div className="stars" />
      ...
      >
        ...
        <motion.div className="mt-12" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
          <div className="relative h-2 bg-white rounded-full max-w-md mx-auto overflow-hidden">
            ...
            />
            <motion.div
              className="absolute top-0 left-0 h-full bg-[#FF9933]/30 rounded-full"
              animate={{
                width: ["0%", "100%", "0%"],
                left: ["0%", "100%", "0%"],
                opacity: [0, 0.7, 0],
